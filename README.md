...
1. Tuberculosis (TB) — chest X-ray classification (appearance/scanner-driven heterogeneity)
2. Polyp segmentation — endoscopy segmentation (structural/geometric heterogeneity)
