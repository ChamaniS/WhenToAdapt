...
def main():
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if val_metrics and val_metrics.get("iou_no_bg", 0) > best_iou:
            ...
            torch.save(model.state_dict(), 'BestModels/best_model_centralized_cvccolon.pth')
            print("Model saved!")

    print("[INFO]: Testing the best model...")
    model.load_state_dict(torch.load('BestModels/best_model_centralized_cvccolon.pth'))
