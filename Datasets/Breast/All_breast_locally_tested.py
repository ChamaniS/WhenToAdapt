...
# -------------------------------
# Dataset: pairs images with masks by stem.
# Masks may have any extension (first match is used).
# -------------------------------
...
def main():
    ...
    # model = DuckNet(input_channels=3, num_classes=1, num_filters=34).to(DEVICE)
    ...
    per_client_results = {}
    for i, cname in enumerate(["BUSBRA", "BUS", "BUSI", "UDIAT"]):
