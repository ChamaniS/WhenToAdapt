...
class SkinPairDataset(Dataset):
    def __init__(self, img_dir, mask_dir, transform=None, img_exts=None, mask_exts=None):
        ...
        for img_path in files:
            ...
            # common alternate naming patterns
...
# -------------------------
# Build train/val/test image & mask directory lists
# -------------------------
...
def train_local_ditto(train_loader, global_local_model, personal_model, server_anchor_model,
    ...
    """
    global_local_model: client copy of global model -> contributes to aggregation
    personal_model: client-private model -> NOT shared
    server_anchor_model: frozen copy of current server global model used in Ditto proximal term
    """
...
def main():
    ...
    # Personalized models per client
    ...
    for r in range(COMM_ROUNDS):
        ...
        for i in range(NUM_CLIENTS):
            ...
            # Personal model continues across rounds
            ...
            personal_models[i] = client_personal  # store updated personal model
        ...
        # Global test on combined test sets
        ...
        # Per-client test: global vs personal
        for i in range(NUM_CLIENTS):
