...
# Non-interactive backend for servers / headless runs
import matplotlib
matplotlib.use("Agg")
...
out_dir = "Outputs_comogan_breast"
...
# =========================================================
# Comparison grids for selected validation images
# =========================================================
...
# =========================================================
# CoMoGAN-style harmonizer stub
# Replace this function with a real generator later if needed
# =========================================================
def harmonize_image_stub(p):
    """
    Visible harmonization stub:
    - autocontrast
    - mild contrast/brightness adjustment
    - small deterministic RGB offsets
    """
...
def harmonize_split_images(client_img_dir, client_name, split_name, out_base):
    """
    Saves harmonized images to:
      out_base/harmonized/<client_name>/<split_name>/images

    Keeps the original filename so masks still pair by stem.
    """
...
def make_comparison_grid_single_filenames(orig_dir, hm_dir, client_name, out_base, desired_filenames):
    """
    For each desired filename:
    - find raw image in orig_dir (case-insensitive)
    - find harmonized image in hm_dir
    - save 3-row comparison grid:
        raw / harmonized / amplified diff
    """
...
# =========================================================
# Dataset helper that pairs images + masks by stem
# =========================================================
...
# =========================================================
# Harmonize all splits once before training
# =========================================================
harm_train_img_dirs = []
harm_val_img_dirs = []
harm_test_img_dirs = []
...
for i, cname in enumerate(client_names):
    ...
    # Save requested comparison grids from the validation split
...
# =========================================================
# Main FedAvg with CoMoGAN-style harmonized inputs
# =========================================================
def main():
    tr_tf = A.Compose([
    ...
    for r in range(COMM_ROUNDS):
        ...
        # Global testing on harmonized test splits
