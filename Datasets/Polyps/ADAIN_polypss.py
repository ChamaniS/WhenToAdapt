...
train_img_dirs =[
r"xxxx\Data\kvasir-seg\Kvasir-SEG\centralized_Kvasir-SEG\train_imgs",
r"xxxx\Data\ETIS-Larib polyp\rearranged\train\images",
r"xxxx\Data\CVC_ClinicDB\PNG\cvc-clinic\rearranged\train\images",
r"xxxx\Data\CVC-ColonDB\CVC-colon\rearranged\train\images",
]
train_mask_dirs =[
r"xxxx\Data\kvasir-seg\Kvasir-SEG\centralized_Kvasir-SEG\train_masks",
r"xxxx\Data\ETIS-Larib polyp\rearranged\train\masks",
r"xxxx\Data\CVC_ClinicDB\PNG\cvc-clinic\rearranged\train\masks",
r"xxxx\Data\CVC-ColonDB\CVC-colon\rearranged\train\masks",
]
val_img_dirs =[
r"xxxx\Data\kvasir-seg\Kvasir-SEG\centralized_Kvasir-SEG\val_imgs",
r"xxxx\Data\ETIS-Larib polyp\rearranged\val\images",
r"xxxx\Data\CVC-ColonDB\CVC-colon\rearranged\val\images",
r"xxxx\Data\CVC_ClinicDB\PNG\cvc-clinic\rearranged\val\images"
]
val_mask_dirs =[
r"xxxx\Data\kvasir-seg\Kvasir-SEG\centralized_Kvasir-SEG\val_masks",
r"xxxx\Data\ETIS-Larib polyp\rearranged\val\masks",
r"xxxx\Data\CVC-ColonDB\CVC-colon\rearranged\val\masks",
r"xxxx\Data\CVC_ClinicDB\PNG\cvc-clinic\rearranged\val\masks"
]
test_img_dirs =[
r"xxxx\Data\kvasir-seg\Kvasir-SEG\centralized_Kvasir-SEG\test_imgs",
r"xxxx\Data\ETIS-Larib polyp\rearranged\test\images",
r"xxxx\Data\CVC-ColonDB\CVC-colon\rearranged\test\images",
r"xxxx\Data\CVC_ClinicDB\PNG\cvc-clinic\rearranged\test\images"
]
test_mask_dirs =[
r"xxxx\Data\kvasir-seg\Kvasir-SEG\centralized_Kvasir-SEG\test_masks",
r"xxxx\Data\ETIS-Larib polyp\rearranged\test\masks",
r"xxxx\Data\CVC-ColonDB\CVC-colon\rearranged\test\masks",
r"xxxx\Data\CVC_ClinicDB\PNG\cvc-clinic\rearranged\test\masks"
]
