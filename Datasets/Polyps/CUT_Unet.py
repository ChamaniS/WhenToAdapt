...
class CUTGenerator (nn .Module ):
    def __init__ (self ,in_ch =3 ,ngf =64 ,n_down =4 ):
        ...
        self .enc2 =enc_block (ngf ,ngf *2 ,down =True )
        self .enc3 =enc_block (ngf *2 ,ngf *4 ,down =True )
        self .enc4 =enc_block (ngf *4 ,ngf *8 ,down =True )
        self .enc5 =enc_block (ngf *8 ,ngf *8 ,down =True )
    ...
    for epoch in range (epochs ):
        ...
        for real_A in loop :
            ...
            for l in nce_layers :
                ...
                q_patches =q_proj .view (Bn ,Cn ,-1 )[:,:,idxs ]
