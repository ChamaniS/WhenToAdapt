...
def main():
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if val_iou_no_bg > best_iou:
            ...
            torch.save(model.state_dict(), "BestModels/best_model_centralized_Unet_isic2017.pth")
            print("Model saved!")

    print("[INFO]: Testing the best model...")
    model.load_state_dict(torch.load("BestModels/best_model_centralized_Unet_isic2017.pth", map_location=DEVICE))
