...
def safe_jaccard_per_class(targets, preds, num_classes):
    """
    Returns per-class IoU using sklearn, with zero_division=0.
    """
...
def accumulate_binary_counts(preds_label, targets):
    """
    preds_label: [B, H, W] or [H, W], values 0/1
...
def compute_metrics_from_counts(TP, TN, FP, FN, smooth=1e-6):
    """
    This matches the metric names you provided.
    For a 2-class segmentation setup, these are computed on the foreground class.
    """
    ...
    # Same logic you used for empty masks
    if TP + FN == 0:
...
# -------------------------
# Evaluation / test / train functions
# -------------------------
...
def main():
    ...
    TRAIN_IMG_DIR = r"C:\Users\csj5\Projects\Data\skinlesions\PH2\train\images"
    TRAIN_MASK_DIR = r"C:\Users\csj5\Projects\Data\skinlesions\PH2\train\masks"
    VAL_IMG_DIR = r"C:\Users\csj5\Projects\Data\skinlesions\PH2\val\images"
    VAL_MASK_DIR = r"C:\Users\csj5\Projects\Data\skinlesions\PH2\val\masks"
    TEST_IMG_DIR = r"C:\Users\csj5\Projects\Data\skinlesions\PH2\test\images"
    TEST_MASK_DIR = r"C:\Users\csj5\Projects\Data\skinlesions\PH2\test\masks"
