...
USE_FDA = True
FDA_L = 0.05
reference_client_idx = 0   # 0 = HAM10K

# Save comparison grids only for these exact target images
...
# Expected extensions per client
client_ext_map = {
    "HAM10K":  ((".jpg",), (".png",)),
    "ISIC2017": ((".jpg",), (".png",)),
    "ISIC2018": ((".jpg",), (".png",)),
...
def build_image_index(folder):
    """
    Build {normalized_stem: full_path} for image lookup.
    """
    idx = {}
...
def find_matching_image_across_dirs(target_name, dirs):
    """
    Search a list of image folders for a file whose stem matches target_name
    after normalization. Returns the first match found, or None.
    """
...
# =========================================================
# Visualization: save only the selected comparison grids
# =========================================================
...
def main():
    ...
    # -----------------------------------------------------
    # Save ONLY the selected comparison grids
    # -----------------------------------------------------
